...
const defaultAvatar = require('../img/avatar.jpg');

const headerImgSource = [
    require('../img/header/1.jpg'),
    require('../img/header/2.jpg'),
    require('../img/header/3.jpg'),
    require('../img/header/4.jpg'),
    require('../img/header/5.jpg'),
    require('../img/header/6.jpg'),
    require('../img/header/7.jpg'),
    require('../img/header/8.jpg'),
    require('../img/header/9.jpg'),
    require('../img/header/10.jpg'),
    require('../img/header/11.jpg')
];
